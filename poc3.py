...
if __name__ == '__main__':
    ...
    parser.add_argument("-u","--url",help="urlfile")
    parser.add_argument("-b","--bit",help="32/64")
    args = parser.parse_args()

    url_list = args.url
    bit = args.bit

    if url_list is None or bit is None:
        print ("Usage:python blue_keep.py -u ./urlfile.txt -b 64")
